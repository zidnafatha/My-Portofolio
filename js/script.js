...
//welcam page
gsap.from('.welcam h1', {scrollTrigger:'.welcam h1', opacity: 0, duration: 1, delay: 0.3, x: -100})
gsap.from('.welcam p', {scrollTrigger:'.welcam p', opacity: 0, duration: 1.5, delay: 0.3, x: -100})
gsap.from('.welcam img', {scrollTrigger:'.welcam img', opacity: 0, duration: 1, delay: 0.3, x: -100})

// home page
gsap.from('.home_photo', {scrollTrigger: '.home_photo', opacity: 0, duration: 0.6, delay: 0.3, x: -100}) 
gsap.from('.home_intro h1', {scrollTrigger: '.home_intro h1', opacity: 0, duration: 0.6, delay: 0.5, x: 100}) 
gsap.from('.home_intro h2', {scrollTrigger: '.home_intro h2', opacity: 0, duration: 0.6, delay: 0.3, x: 100}) 
gsap.from('.home_intro p', {scrollTrigger: '.home_intro p', opacity: 0, duration: 0.6, delay: 0.7, x: 100})
gsap.from('.home_social a', {scrollTrigger: 'home_social a', opacity: 0, duration: 1, delay: 1.2, y: 30, stagger: 0.2})  
...
gsap.from('.services-content div', {scrollTrigger:'.services-content div',opacity: 0, duration: 1, delay: 1.1, y: -30, stagger: 0.3})
